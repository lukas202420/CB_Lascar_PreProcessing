...
expected_counts_monthly = dataframe.groupby('month').size()
...
monthly_slope_avg_per_year = monthly_result_avg.slope * 12
monthly_slope_min_per_year = monthly_result_min.slope * 12
monthly_slope_max_per_year = monthly_result_max.slope * 12



# messed up slope calculation *365?
...
weekly_slope_avg_per_year = weekly_result_avg.slope * 52
weekly_slope_min_per_year = weekly_result_min.slope * 52
weekly_slope_max_per_year = weekly_result_max.slope * 52
